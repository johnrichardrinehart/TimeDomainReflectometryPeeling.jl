...
@test_approx_eq_eps(reflected_voltage_signal_to_reflection_coefficients(reflection_coefficients_to_reflected_voltage_signal([.2,.3,-.1,.1],4),bouncing_tolerance=1), [.2,.3,-.11978,.110776], 1e-3)
