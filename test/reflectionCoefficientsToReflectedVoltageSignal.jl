...
@test_approx_eq_eps(reflectionCoefficientsToReflectedVoltageSignal([-.25,50/110,-30/130,30/130,-50/110,.25],4,bouncing_tolerance=1), [-.25,.176136,.176136,.176136],1e-3)
